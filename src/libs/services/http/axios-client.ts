...
import apisauce, { type ApiResponse, type ApisauceConfig } from 'apisauce'
import { type IHttpServiceClient } from './http-service-client.interface'
...
export class AxiosClient implements IHttpServiceClient<IAxiosOptions> {
  ...
  public get<TResponse = unknown, TParams = unknown>(
    ...
    return this.axiosInstance.get(url, params as any, options)
  }
  ...
  public delete<TResponse = unknown, TBody = unknown>(
    ...
    return this.axiosInstance.delete(url, body as any, options)
  }
